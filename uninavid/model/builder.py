...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda"):
    ...
    is_waypoint_model = getattr(cfg_pretrained, "model_type", "") == "llava_waypoint" or hasattr(cfg_pretrained, "num_waypoints")
    is_vid_model = ('vid' in model_name.lower()) or is_waypoint_model
